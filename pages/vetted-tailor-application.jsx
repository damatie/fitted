 ...
 const handleSubmit =()=>{
  ...
  return (
    <Layout title="Vetted Tailor Application">
      ...
      <main  className='w-full md:w-8/12  lg:w-8/12 xl:w-10/12 mx-auto'>
        {
          success ? (
          ...
          <div className=' grid  grid-cols-1 xl:grid-cols-2 mt-12'>
            ...
            <ProfileImage/>
              <div className=' flex flex-col md:w-5/12  max-auto xl:w-8/12 mt-8 text-xs mx-auto xl:mx-0 xl:text-base'>
                {data.map((item, index) => (
